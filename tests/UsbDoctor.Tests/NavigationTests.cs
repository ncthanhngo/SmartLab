...
public sealed class NavigationTests
{
    ...
    public void EveryDeclaredStageBelongsToADeclaredSection()
    {
        ...
        var views = Path.Combine(FindRepoRoot(), "src", "UsbDoctor.App", "Views");
    ...
    private static string FindRepoRoot()
    {
        ...
        while (directory is not null && !File.Exists(Path.Combine(directory.FullName, "UsbDoctor.sln")))
