...
public sealed class DefenderBridgeTests
{
    ...
    {
        // USB Doctor identifies hiding behaviour. Naming a program is Defender's job,
    ...
    public void FindingsStayAttributableToTheirSource()
    {
        ...
        Assert.Contains("USB Doctor", MalwareRemovalViewModel.HidingSource, StringComparison.Ordinal);
