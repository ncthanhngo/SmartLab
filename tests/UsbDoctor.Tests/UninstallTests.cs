...
public class SelfTraceScannerTests
{
    private static readonly UninstallPaths Paths =
        new(@"C:\Users\tester\AppData\Local", @"C:\Users\tester", @"C:\Apps\USB Doctor");

    [Fact]
    public void Only_traces_that_exist_are_listed()
    {
        var probe = new FakeTraceProbe();
        probe.Directories.Add(@"C:\Users\tester\AppData\Local\UsbDoctor");
        ...
        Assert.Contains("UsbDoctor", trace.Location, StringComparison.Ordinal);
    }
    ...
    {
        var probe = new FakeTraceProbe();
        probe.Directories.Add(@"C:\Users\tester\UsbDoctor\rescue");
        probe.Directories.Add(@"C:\Users\tester\UsbDoctor\quarantine");
        probe.Directories.Add(@"C:\Users\tester\UsbDoctor\recovered");
        probe.Directories.Add(@"C:\Users\tester\AppData\Local\UsbDoctor");
        probe.Directories.Add(@"C:\Apps\USB Doctor");
        ...
        Assert.False(traces.Single(t => t.Location.EndsWith(@"Local\UsbDoctor", StringComparison.Ordinal)).IsUserData);
        Assert.False(traces.Single(t => t.Location == @"C:\Apps\USB Doctor").IsUserData);
    }
    ...
    public void Directory_sizes_are_reported()
    {
        var probe = new FakeTraceProbe();
        probe.Directories.Add(@"C:\Users\tester\UsbDoctor\rescue");
        probe.Sizes[@"C:\Users\tester\UsbDoctor\rescue"] = 14_862_032_942;
