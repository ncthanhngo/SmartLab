...
public sealed class LargeOldFileTests
{
    ...
    public void TheHeadingNamesWhichClockItRead()
    {
        ...
        var summary = UsbDoctor.App.LargeOldFilesViewModel.Summarise(12, 0, "4.2 GB");
...
public sealed class SecureDeleteTests
{
    ...
    {
        var path = Path.Combine(Path.GetTempPath(), $"usbdoctor-shred-{Guid.NewGuid():N}.bin");
    ...
    {
        var caveat = UsbDoctor.App.ShredderViewModel.DriveCaveat(confidence);
