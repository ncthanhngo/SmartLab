...
namespace SmartLab.App.Theming;
...
{
    private const string SettingsKey = @"Software\Smart Lab";
        ...
        var replacement = new ResourceDictionary
        {
            Source = new Uri(
                theme == AppTheme.Light
                    ? "pack://application:,,,/SmartLab.App;component/Themes/Palette.Light.xaml"
                    : "pack://application:,,,/SmartLab.App;component/Themes/Palette.Dark.xaml",
                UriKind.Absolute),
        };
